export const usersStyles = {
  ...
  roleRow: 'flex flex-col sm:flex-row gap-3',
  statusRow: 'flex items-center gap-2 mb-2',
  confirmOverlay: 'fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4',
  confirmDialog: 'w-full max-w-md rounded-2xl bg-surface border border-border p-6 shadow-lg',
  confirmTitle: 'text-lg font-bold text-text mb-2',
  confirmBody: 'text-sm text-text-secondary mb-6',
